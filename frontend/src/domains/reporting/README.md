# Reporting (frontend domain folder)

Dashboards (incl. LOS), data warehouse, sustainability/CO2; read-only.

This folder mirrors the backend `OpenTms.Reporting` module (see the domain map in `/CLAUDE.md`).
