# MasterData (frontend domain folder)

Relations, addresses, vehicles, drivers.

This folder mirrors the backend `OpenTms.MasterData` module (see the domain map in `/CLAUDE.md`).
